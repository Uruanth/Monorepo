...
VALUES (1, "ADMINISTRADOR", "is ADMINISTRADOR");
INSERT INTO roles (id, descripcion, nombre)
VALUES (2, "PROPIETARIO", "is PROPIETARIO");
INSERT INTO roles (id, descripcion, nombre)
VALUES (3, "EMPLOYEE", "is EMPLOYEE");
INSERT INTO roles (id, descripcion, nombre)
VALUES (4, "CLIENTE", "is CLIENTE");

-- Create user query
INSERT INTO usuarios (id, correo, apellido, celular, nombre, clave, id_rol)
VALUES (1, "correo@test.com", "test L", "123131231", "test N", "test P", 1);
~~~
